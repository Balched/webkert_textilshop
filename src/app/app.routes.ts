...
import { AdminProductsComponent } from './pages/admin-products/admin-products/admin-products.component';
...
export const routes: Routes = [
  ...
  { path: 'admin-products', loadComponent: () => import('./pages/admin-products/admin-products/admin-products.component').then(m => m.AdminProductsComponent), canActivate: [authGuard]},
